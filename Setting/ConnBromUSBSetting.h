...
public:
    ...
    DA_LOG_CHANNEL_E get_da_log_channel()
    {
        return m_da_log_channel;
    }

    void set_da_log_channel(unsigned int log_channel)
    {
        m_da_log_channel = (DA_LOG_CHANNEL_E)log_channel;
    }

    void set_battery_option(USBPower p)
    {
        power_ = p;
    }
